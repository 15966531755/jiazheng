...
<body>
<div class="topToolbar"> <span class="title">找阿姨管理</span> <a href="javascript:location.reload();" class="reload">刷新</a></div>
...
$row_a = $dosql->GetOne("SELECT * FROM `area` WHERE `areaid`=".$row['area']);
		...
		<tr align="left" class="dataTr">
			...
			<td class="action endCol"> <span class="nb"><a href="goodszay_save.php?action=del2&id=<?php echo $row['id']; ?>" onclick="return ConfDel(0)">删除</a></span></td>
		</tr>
		<?php
		}	
	?>
...
?>
<div class="bottomToolbar"> <span class="selArea"><span>选择：</span> <a href="javascript:CheckAll(true);">全部</a> - <a href="javascript:CheckAll(false);">无</a> - <a href="javascript:DelAllNone('goodszay_save.php');" onclick="return ConfDelAll(0);">删除</a></span> </div>
...
<div class="quickToolbar">
	<div class="qiuckWarp">
		<div class="quickArea"> <span class="selArea"><span>选择：</span> <a href="javascript:CheckAll(true);">全部</a> - <a href="javascript:CheckAll(false);">无</a> - <a href="javascript:DelAllNone('goodszay_save.php');" onclick="return ConfDelAll(0);">删除</a></span> <span class="pageSmall">
