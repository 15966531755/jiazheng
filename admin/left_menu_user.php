	...
	<div class="viewport">
		<div class="overview">
			...
			else
			{
				...
				$leftMenu04_Str = '';
				$leftMenu04_Arr = array('goodstype'=>'<a href="goodstype.php" target="main">服务类别管理</a>',
									'goodsbrand'=>'<a href="goodsbrand.php" target="main">品牌类型管理</a>',
									'goods'=>'<a href="goods.php" target="main">服务列表管理</a>',
									'goodsorder'=>'<a href="goodsorder.php" target="main">服务订单管理</a>',
									...
									'goodsflag'=>'<a href="goodsflag.php" target="main" title="服务信息属性管理" class="goodsinfoattr"></a>');
...
//				}
				...
				if($leftMenu04_Str != '')
				{
					...
					if($leftMenu01_Str != '' or
					   ...
					   $leftMenu03_Str != '')
					{
						echo '<div class="menubox"><div class="title" onclick="DisplayMenu(\'leftmenu04\');" title="点击切换显示或隐藏"> 服务订单管理 </div><div id="leftmenu04" style="display:none">';
					}
					else
					{
						echo '<div class="menubox"><div class="title on" id="t1" onclick="DisplayMenu(\'leftmenu04\');" title="点击切换显示或隐藏"> 服务订单管理 </div><div id="leftmenu04">';
					}
