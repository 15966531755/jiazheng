...
<form name="form" id="form" method="post" action="goods_save.php" onsubmit="return cfm_goods();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		...
		<tr>
			<td height="40" align="right">服务品牌：</td>
		...
		<tr>
			<td height="40" align="right">服务名称：</td>
		...
		<tr class="nb">
			<td colspan="2" height="26" id="getattr"><div style="text-align:center;color:#9C0;">请选择服务分类获取自定义属性</div></td>
		</tr>
		<tr class="nb">
			<td colspan="2" height="26"><div class="line"></div></td>
		</tr>
		...
		<tr>
			<td height="40" align="right">服务价格：</td>
		...
		<tr>
			<td height="40" align="right">服务编号：</td>
			<td><input name="goodsid" type="text" id="goodsid" class="input" /></td>
		</tr>
		<tr>
			<td height="40" align="right">服务重量：</td>
