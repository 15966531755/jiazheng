...
<body>
<?php
$row = $dosql->GetOne("SELECT * FROM `#@__city` WHERE `id`=$id");
?>
<div class="formHeader"> <span class="title">修改地区</span> <a href="javascript:location.reload();" class="reload">刷新</a> </div>
<form name="form" id="form" method="post" action="city_save.php" onsubmit="return cfm_weblink();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		...
		<tr>
			...
			<td><input type="text" name="city" id="city" class="input" value="<?php echo $row['city']; ?>" />
