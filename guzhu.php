...
<a href="guzhu-<? echo $row['id'];?>.html" target="_blank"><? echo $rows['name'];?> <? echo $rows['gz'];?></a>        </div>
        ...
        <div class="summary"><? if (!empty($row_c)){   if($row_c['city'] != ""){echo $row_c['city'];}?><? if($row_a['area'] != ""){echo $row_a['area'];}}?> </div>
        <div class="salary">
...
<script language="javascript" type="text/javascript">
 ...
 <div class="aysx_main_bottom" style="text-align:center;  margin-bottom: 10px;">
