...
<div class="require_box">
	<div class="require">
    	...
    	<div class="set01">
            <p>姓名：</p>
            <div class="set_in1">
          <input value="" type="text" name="name_g" id="name_g" style="outline:none; border:none;"/>
            </div>
        </div>
        ...
        <div class="set01">
            <p>手机号：</p>
            <div class="set_in1">
          <input value="" type="text" name="mobile_g" id="mobile_g" style="outline:none; border:none;"/>
            </div>
        </div>
...
?>
        ...
        <div class="req05">
        	<p><a style=" cursor:pointer;" onclick="s_g();">确认发布</a></p>
        </div>
    </div>
</div>
</form>
 ...
 <script type="text/javascript">
				   ...
				   function s_g(){
					   ...
					   var username = document.getElementById("usernames").value;
					     var name = document.getElementById("name_g").value;
						 var province = document.getElementById("province").value;
						 var city = document.getElementById("city").value;
						 var area = document.getElementById("area").value;
						    var gz = document.getElementById("gz_g").value;
					   	var mobilephone = document.getElementById("mobile_g").value;
