...
class WEIXINclient {
    ...
    function __construct($access_token, $refresh_token = NULL) {
        $this->oauth = new WEIXIN($access_token, $refresh_token);
        /*
         * 初始化APIMap
        ...
        $this->APIMap = array(
            /*                       qzone                    */
            "add_blog" => array(
                "https://api.weixin.qq.com/sns/blog/add_one_blog",
                array("title", "format" => "json", "content" => null),
                "POST"
            ),
            "add_topic" => array(
                "https://api.weixin.qq.com/sns/shuoshuo/add_topic",
                array("richtype", "richval", "con", "#lbs_nm", "#lbs_x", "#lbs_y", "format" => "json", "#third_source"),
                "POST"
            ),
            "get_user_info" => array(
                "https://api.weixin.qq.com/sns/user/get_user_info",
                array("format" => "json"),
                "GET"
            ),
            "add_one_blog" => array(
    ...
    private function _applyAPI($arr, $argsList, $baseUrl, $method) {
        $pre = "#";
        $keysArr = array(
            "oauth_consumer_key" => WEIXIN_AKEY,
            "access_token" => $_SESSION['weixin_token']["access_token"],
            "openid" => $_SESSION['weixin_token']["openid"]
        );
        ...
        if ($method == "POST") {
            if ($baseUrl == "https://api.weixin.qq.com/sns/blog/add_one_blog") {
    ...
    public function get_access_token() {
        return $_SESSION['weixin_token']["access_token"];
    }
