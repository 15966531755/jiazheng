...
//define('WEIXIN_AKEY', $cfg_weixin_appid);
//define('WEIXIN_SKEY', $cfg_weixin_appkey);
//define('WEIXIN_SCOPE', 'get_user_info,add_share,list_album,add_album,upload_pic,add_topic,add_one_blog,add_weibo,check_page_fans,add_t,add_pic_t,del_t,get_repost_list,get_info,get_other_info,get_fanslist,get_idolist,add_idol,del_idol,get_tenpay_addr');
