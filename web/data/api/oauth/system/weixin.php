...
class weixinOAuth {
    ...
    function accessTokenURL() {
        return 'https://api.weixin.qq.com/sns/oauth2.0/token';
    }

    function authorizeURL() {
        return 'https://api.weixin.qq.com/sns/oauth2.0/authorize';
    }

    function openidURL() {
        return "https://api.weixin.qq.com/sns/oauth2.0/me";
    }

    function __construct($access_token = NULL, $refresh_token = NULL) {
        $this->client_id = weixin_AKEY;
        $this->client_secret = weixin_SKEY;
