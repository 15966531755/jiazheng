	...
	<div class="OneOfTwos">
		<ul class="goodstype">
			...
			if($cfg_isreurl=='Y')
				...
				$gourl = 'goods.php';
			?>
			<li class="alltype"><a href="<?php echo $gourl; ?>">全部服务类型</a></li>
			<?php
		...
		<div class="goodsConts">
			...
			<div class="goodsarea"> 
				...
				<div class="fr">
					...
					<div class="tb-skin">
						<p class="tb-note-title"><span>请选择您要的服务信息</span><a href="shoppingcart.php" class="end">结算购物车</a></p>
						<form name="gform" id="gform" method="post">
							...
							&nbsp;&nbsp;件
							<div class="tb-action"> <a href="javascript:;" id="buynow" onclick="BuyNow();" title="点击此按钮，到下一步确认购买信息。">立刻购买</a> <a href="javascript:;" id="addcart" onclick="AddShoppingCart();" title="点击此按钮，将服务加入到购物车。">加入购物车</a></div>
			...
			<ul class="tabs" id="tabs">
				<li id="tabs_title0" onmouseover="Tabs('tabs',this);" class="active"><a href="javascript:;">服务描述</a></li>
