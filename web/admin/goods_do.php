...
<table width="100%" border="0" cellpadding="0" cellspacing="0" id="ajaxlist" class="dataTable">
	...
	if($cfg_adminlevel == 3){
					$sql .= "AND `brandpstr` = '".$_SESSION['admin']."'";
					}
	...
	while($row = $dosql->GetArray())
	{
		...
		if(isset($r['classname']))
			...
			$classname = $r['classname'].'('.$row['typename'].') ['.$row['classid'].']';
		else
...
?>
<div class="bottomToolbar"> <span class="selArea"><span>选择：</span> <a href="javascript:CheckAll(true);">全部</a> - <a href="javascript:CheckAll(false);">无</a> - <a href="javascript:;" onclick="AjaxClearAll();">删除</a></span> <a href="goods_add.php" class="dataBtn">添加服务信息</a></span> </div>
...
<div class="quickToolbar">
	<div class="qiuckWarp">
		<div class="quickArea"> <span class="selArea"><span>选择：</span> <a href="javascript:CheckAll(true);">全部</a> - <a href="javascript:CheckAll(false);">无</a> - <a href="javascript:;" onclick="AjaxClearAll();">删除</a></span> <a href="goods_add.php" class="dataBtn">添加服务信息</a></span> <span class="pageSmall"><?php echo $dopage->AjaxPageSmall(); ?></span> </div>
