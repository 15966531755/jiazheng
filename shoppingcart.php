...
<!-- mainbody-->
<div class="subBody">
	<div class="subTitle" style="margin:0;"> <span class="catname shopcart">服务购物车</span> <a href="shoppingcart.php?a=empty"><strong>清空购物车</strong></a>
		<div class="cl"></div>
	</div>
	<?php
	...
	{
		echo '<div class="shoppingcartempty">您的购物车目前没有服务！</div>';
	}
	?>
</div>
<!-- /mainbody--> 
