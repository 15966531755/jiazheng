     ...
     <input type="hidden" name="gourl" id="gourl" value="<? echo $_GET['url'];?>"/>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tbody>
				...
				<tr>
					<td height="40"> </td>
					<td colspan="2" valign="bottom">合作账号：<a href="data/api/oauth/connect.php?method=qq_token" class="oqq">QQ登录</a> 
<!-- <a href="data/api/oauth/connect.php?method=weibo_token" class="osina">微博登录</a>-->
<a href="data/api/oauth/connect.php?method=weixin_token" class="owx">微信登陆</a>
</td>
