	...
	<div class="rightarea">
		<form name="form" id="form" method="post" action="?a=saveedit" onsubmit="return cfm_upmember();">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
					<td height="40" align="right">微信绑定：</td>
					<td><?php if($r_user['weixinid'] != ''){echo $r_user['weixinid'].'&nbsp;&nbsp;<span class="removeoauth"><a href="?a=removeoweixin">解除绑定</a></span>';}else{echo '暂无绑定';} ?></td>
				</tr>
